...
export default class ActionPointReferenceRepositoryService extends BaseRepositoryService {
	constructor() {
		...
		super(BaseRepositoryService.collectioNames.actionPointReference, toDocument, toObject, buildWhereClause);
	}
}
