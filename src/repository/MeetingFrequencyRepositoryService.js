...
export default class MeetingFrequencyRepositoryService extends BaseRepositoryService {
	constructor() {
		...
		super(BaseRepositoryService.collectioNames.meetingFrequency, toDocument, toObject, buildWhereClause);
	}
}
