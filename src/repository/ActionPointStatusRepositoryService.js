...
export default class ActionPointStatusRepositoryService extends BaseRepositoryService {
	constructor() {
		...
		super(BaseRepositoryService.collectioNames.actionPointStatus, toDocument, toObject, buildWhereClause);
	}
}
