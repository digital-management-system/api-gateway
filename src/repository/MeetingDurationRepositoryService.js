...
export default class MeetingDurationRepositoryService extends BaseRepositoryService {
	constructor() {
		...
		super(BaseRepositoryService.collectioNames.meetingDuration, toDocument, toObject, buildWhereClause);
	}
}
