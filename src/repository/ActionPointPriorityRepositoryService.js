...
export default class ActionPointPriorityRepositoryService extends BaseRepositoryService {
	constructor() {
		...
		super(BaseRepositoryService.collectioNames.actionPointPriority, toDocument, toObject, buildWhereClause);
	}
}
